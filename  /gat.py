...
from utils.layers import AttentionHead
from models.base_gattn import BaseGAttN


class GAT(BaseGAttN):
    """Dense Graph Attention Network.
    ...
    def __init__(self, in_features, nb_classes, hid_units, n_heads,
        ...
        # Build hidden layers as ModuleList of ModuleLists
        self.hidden_layers = nn.ModuleList()

        # First hidden layer: input → hid_units[0], no residual
        ...
        # Output layer: no activation (identity), averaged across heads
    ...
    def forward(self, inputs, bias_mat):
        # inputs:   [batch, nb_nodes, in_features]
        # bias_mat: [batch, nb_nodes, nb_nodes] — 0 for edges, large negative for non-edges
